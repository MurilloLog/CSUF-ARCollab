...
public class PlanetXEditor : ShaderGUI
{
    ...
    public Texture2D Clouds_Light = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Exo-planets - NovaShade/Resources/Textures/Clouds_Light.tga", typeof(Texture2D));
    public Texture2D Clouds_Average = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Exo-planets - NovaShade/Resources/Textures/Clouds_Average.tga", typeof(Texture2D));
    public Texture2D Clouds_Heavy = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Exo-planets - NovaShade/Resources/Textures/Clouds_Heavy.tga", typeof(Texture2D));

    public Texture2D Clouds_Light_N = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Exo-planets - NovaShade/Resources/Textures/Clouds_Light_N.tga", typeof(Texture2D));
    public Texture2D Clouds_Average_N = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Exo-planets - NovaShade/Resources/Textures/Clouds_Average_N.tga", typeof(Texture2D));
    public Texture2D Clouds_Heavy_N = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Exo-planets - NovaShade/Resources/Textures/Clouds_Heavy_N.tga", typeof(Texture2D));

    public Texture2D headerTexture = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Exo-planets - NovaShade/Resources/Textures/headerTexture.png", typeof(Texture2D));
    ...
    private void Clouds(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        MaterialProperty EnumFloat = ShaderGUI.FindProperty("_EnumFloat", properties); // Added this line
            ...
            using (new EditorGUI.DisabledGroupScope(EnableClouds.floatValue == 0))
            {
                ...
                switch (CloudsText)
                {
                    case OPTIONS2.LightClouds:
                        targetMaterial.SetTexture("_CloudsTexture", Clouds_Light);
                        targetMaterial.SetTexture("_CloudsNormals", Clouds_Light_N);
                        CloudsText = OPTIONS2.LightClouds;
                        break;

                    case OPTIONS2.AverageClouds:
                        targetMaterial.SetTexture("_CloudsTexture", Clouds_Average);
                        targetMaterial.SetTexture("_CloudsNormals", Clouds_Average_N);
                        break;

                    case OPTIONS2.HeavyClouds:
                        targetMaterial.SetTexture("_CloudsTexture", Clouds_Heavy);
                        targetMaterial.SetTexture("_CloudsNormals", Clouds_Heavy_N);
                        break;
